DROP TEMPORARY TABLE IF EXISTS tmp_cfda_table;
CREATE TEMPORARY TABLE tmp_cfda_table (
...
FROM tmp_cfda_table WHERE CFDA_NBR NOT IN (SELECT CFDA_NBR FROM CFDA);

DROP TEMPORARY TABLE tmp_cfda_table;
