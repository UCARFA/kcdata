...
VALUES ('UCAR', '000001', 'UCAR', 'admin', 	NOW(), UUID(), 1, 'Y'),
 ...
 ('AIM', 'HAO', 'NCAR-HAO-AIM', 'admin', 	NOW(), UUID(),1, 'N'),
 ('IG', 'HAO', 'NCAR-HAO-IG', 'admin', 		NOW(), UUID(),1, 'Y'),
 ('LSV', 'HAO', 'NCAR-HAO-LSV', 'admin', 	NOW(), UUID(),1, 'N'),
 ('MLSO', 'HAO', 'NCAR-HAO-MLSO', 'admin', 	NOW(), UUID(),1, 'Y'),
 ('HAP', 'RAL', 'NCAR-RAL-HAP', 'admin', 	NOW(), UUID(),1, 'Y'),
 ('STSW', 'HAO', 'NCAR-HAO-STSW', 'admin', 	NOW(), UUID(),1, 'N'),
 ('SOLAR', 'HAO', 'NCAR-HAO-SOLAR', 'admin', 	NOW(), UUID(),1, 'Y'),
 ('GEOSPACE', 'HAO', 'NCAR-HAO-GEOSPACE', 'admin', 	NOW(), UUID(),1, 'Y'),
