...
DROP TEMPORARY TABLE IF EXISTS report_status_table;
CREATE TEMPORARY TABLE report_status_table (
...
INSERT report_status_table (REPORT_STATUS_CODE, DESCRIPTION, ACTIVE_FLAG, UPDATE_TIMESTAMP, UPDATE_USER, VER_NBR, OBJ_ID)
VALUES 
