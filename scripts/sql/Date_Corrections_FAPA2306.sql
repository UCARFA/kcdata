...
-- Mac/UNIX - 
LOAD DATA LOCAL INFILE '~/git/kcdata/scripts/sql/dataFiles/dateCorrections_FAPA2306.csv'
-- WINDOWS (fateam) - LOAD DATA LOCAL INFILE 'scripts\sql\dataFiles\\dateCorrections_FAPA2306.csv'
